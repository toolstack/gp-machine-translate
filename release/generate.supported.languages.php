...
$providerManager = new ProviderManager(null, null);
$providers = $providerManager->getProviderIdentifiers();
$banners = $providerManager->getProvidersDisplayName();
...
foreach( $providers as $provider ) {
    ...
    $gp_machine_translate_locales = $providerManager->getOrCreateProviderInstance($provider)->getLocales();
